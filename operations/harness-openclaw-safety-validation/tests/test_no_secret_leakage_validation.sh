...
API_KEY_FILE="${VALID_RUN_DIR}/leak_api_key.txt"
API_KEY_CONTENT="OPENAI_API_KEY=sk-test-secret-value"
printf '%s' "${API_KEY_CONTENT}" > "${API_KEY_FILE}"
assert_file_unchanged_after_failure "api-key-assignment" "${API_KEY_FILE}" "${API_KEY_CONTENT}"
